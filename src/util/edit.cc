...
/*
 * Warning: it can destruct iterator `it`
 */
void EditEngine::trySquashWithPrev(QMap<size_t, EditNode>::iterator it) {
...
void EditEngine::trySquash(QMap<size_t, EditNode>::iterator it) {
  auto next = it;
  ++next;
